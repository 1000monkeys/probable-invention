...
def run_game():
    ...
    number_stars_x = int(available_space_x / star_rect.width)

    available_space_y = 768
    number_stars_y = int(available_space_y / star_rect.height)
    ...
    for x in range(number_stars_x):
        for y in range(number_stars_y):
            ...
            star.rect.x = x * star_rect.width
            star.rect.y = y * star_rect.height
            stars.add(star)
